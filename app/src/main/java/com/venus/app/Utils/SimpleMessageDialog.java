...
public class SimpleMessageDialog extends AppCompatDialogFragment {
    ...
    public static SimpleMessageDialog newInstance(String message) {
        return new SimpleMessageDialog().putArguments(message);
    }

    public static SimpleMessageDialog newInstance(String message, boolean isTerminating) {
        return new SimpleMessageDialog().putArguments(message, isTerminating);
    }
